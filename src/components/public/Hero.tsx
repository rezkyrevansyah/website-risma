    ...
    <section className="relative min-h-screen flex items-center overflow-hidden bg-slate-50 text-slate-900 selection:bg-emerald-200">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <motion.div 
          ...
          className="absolute bottom-[-20%] right-[-10%] w-[600px] h-[600px] bg-teal-200/40 rounded-full blur-[100px]" 
        />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            <motion.div 
              ...
              className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-emerald-200 bg-emerald-50 text-emerald-700 text-xs font-bold tracking-[0.2em] uppercase"
            >
            ...
            <motion.h1 
              ...
              className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-bold tracking-tight leading-[1.1] sm:leading-[0.9] text-slate-900 mt-4 sm:mt-0"
            >
              MASJID <br/>
            ...
            <motion.p 
              ...
              className="text-base sm:text-lg md:text-xl text-slate-600 max-w-xl leading-relaxed border-l-2 border-emerald-500/30 pl-4 sm:pl-6"
            >
          ...
          <div className="lg:col-span-5 relative hidden lg:block h-[600px]">
             ...
             <motion.div 
               ...
               className="relative h-full w-full rounded-[3rem] overflow-hidden border border-white shadow-2xl bg-white group"
             >
                <div
